...
• Payée - paiement reçu et confirmé. Dans de rares cas, une facture peut s'afficher comme Payée alors qu'aucun paiement n'est encore enregistré, par exemple après une importation ou une ancienne action "marquer comme payée" n'ayant pas créé d'écriture de paiement. Le bloc de paiement affiche alors "Cette facture est marquée comme payée, mais {amount} n'est pas enregistré comme paiement" et propose d'enregistrer le paiement.
