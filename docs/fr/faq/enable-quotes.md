...
chatbot:
  ...
  actions:
    - { label: "Open features", to: "/settings?section=features" }
...
Si les devis ne sont pas visibles dans la navigation :
1. Allez dans Parametres de l espace de travail → Fonctionnalites
2. Activez-y la fonction Quotes
3. Le menu se met a jour immediatement si la fonction est disponible pour votre espace de travail

Astuce : verifiez aussi que votre compte a l acces a la page Devis.
