...
L authentification a deux facteurs n est pas disponible dans cette version de l application pour le moment.

Vous pouvez quand meme ouvrir Mon compte → Securite pour consulter les options de securite actuellement disponibles a cet endroit.

Si la 2FA est ajoutee plus tard, elle apparaitra dans cette section.
