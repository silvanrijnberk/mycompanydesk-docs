...
2. Activez ou désactivez les sujets de notification. Les catégories sont :
   - **Factures qui méritent votre attention** : factures en retard, factures proches de l'échéance, brouillons laissés en suspens, prélèvements échoués, envois de factures échoués, facturation automatique des contrats suspendue et heures sans tarif.
