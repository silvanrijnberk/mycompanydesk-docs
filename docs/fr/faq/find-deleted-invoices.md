...
description: "Les factures supprimées se trouvent dans Factures > Corbeille. Si vous êtes déjà dans la liste des factures, passez à la vue Corbeille."
...
Les factures supprimées se trouvent dans Factures -> Corbeille. Si vous êtes déjà dans la liste des factures, passez à la vue Corbeille. S'il s'agit plutôt de factures archivées, utilisez la vue Archives.
