...
Astuce : Les informations de votre signature sont partagées avec les informations de votre entreprise ; les remplir une seule fois suffit pour que chaque e-mail soit complet.
