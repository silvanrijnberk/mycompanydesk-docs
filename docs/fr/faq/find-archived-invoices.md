...
Les factures archivées se trouvent dans Factures -> Archives. Si vous êtes déjà dans la liste des factures, passez à la vue Archives. Les factures supprimées se trouvent dans la Corbeille.
