...
description: "MyCompanyDesk peut importer des clients, des factures et des dépenses depuis un fichier CSV. Les autres types de données ne peuvent pas être importés."
