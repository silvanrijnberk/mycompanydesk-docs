---
title: "Ajouter une boîte mail ou une adresse e-mail"
...
- Vous ne pouvez ajouter une boîte mail qu'une fois l'inbox activée sur votre domaine. Pas encore de domaine connecté ? Commencez par [Domaines, site web et boîte de réception](/fr/features/domains-website-inbox).
- L'inbox sur votre propre domaine fait partie d'Office, voir [Formules et tarifs](/fr/faq/plans).
- Les e-mails envoyés à une adresse de votre domaine qui ne correspond à aucune boîte arrivent dans la boîte marquée **Standaard** (par défaut).
- Votre adresse e-mail de connexion est une autre chose. Voir [Modifier l'adresse e-mail](/fr/faq/change-email).
