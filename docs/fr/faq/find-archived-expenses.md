...
Les dépenses archivées se trouvent dans Dépenses -> Archives. Si vous êtes déjà dans la liste des dépenses, passez à la vue Archives. Les dépenses supprimées se trouvent dans la Corbeille.
