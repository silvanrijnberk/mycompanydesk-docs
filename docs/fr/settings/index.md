...
- L'[assistant de configuration](/fr/features/setup-wizard) remplit la plupart des paramètres d'entreprise au premier démarrage et peut être relancé à tout moment.
- [Vos paramètres personnels](/fr/account/profile) détaille le groupe À votre sujet.
- [Sécurité](/fr/account/security) couvre les mots de passe, la vérification en deux étapes et les passkeys.
- [Import et export de données](/fr/account/data) couvre Télécharger les données et l'import CSV.
- [Gestion de l'équipe](/fr/settings/team) couvre l'accès des partenaires et comptables.
- [Abonnement et forfaits](/fr/settings/billing) couvre votre abonnement.
