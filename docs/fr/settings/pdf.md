...
Accordez vos PDF de factures, devis et relances à votre marque. Deux pages de paramètres déterminent l'apparence, et un seul style s'applique à tous vos documents.

- **Logo et couleur :** votre logo et votre couleur de marque, la base de tout.
- **Mise en page des factures :** le studio de conception où vous stylez le document lui-même, avec un aperçu en direct.

Les deux se trouvent dans les **paramètres**. Consultez l'[aperçu des paramètres](/fr/settings/) pour la carte complète.
...
Les PDF de documents existent en néerlandais, anglais, allemand et français. Les documents d'un espace de travail néerlandais sont produits en néerlandais par défaut, pour que les libellés de vos factures correspondent à ce que vos clients attendent.

## Conseils pour le logo

Pour le meilleur résultat sur les PDF :

- **Format :** un PNG à fond transparent fonctionne le mieux ; JPG et SVG sont aussi acceptés
- **Résolution :** au moins 300 pixels de large
