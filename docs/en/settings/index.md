...
See [Your personal settings](/en/account/profile) for a walkthrough of these four pages.
...
- [Setup wizard](/en/features/setup-wizard) fills most business settings on first run and can be re-run at any time.
- [Your personal settings](/en/account/profile) covers the Over jou group in detail.
- [Security](/en/account/security) covers passwords, two-step verification and passkeys.
- [Data import and export](/en/account/data) covers Gegevens downloaden and CSV import.
- [Team management](/en/settings/team) covers access for partners and accountants.
- [Billing and plans](/en/settings/billing) covers your subscription.
