...
description: "To reduce invoice mistakes: complete the billing email, address, VAT number and default payment terms on the customer, then reuse that customer."
...
chatbot:
  ...
  follow_up:
    - "How do I set up customer profiles?"
