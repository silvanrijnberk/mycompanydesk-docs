...
description: "The application has a small set of keyboard shortcuts: press Cmd+K (Mac) or Ctrl+K (Windows/Linux) to open the search palette: search customers."
...
See [Keyboard Shortcuts](/en/advanced/keyboard-shortcuts) for the full overview.
