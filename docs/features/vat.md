...
- **Buitenlandse BTW**: buitenlandse BTW die aan jou is berekend en mogelijk via de EU-teruggaafprocedure terug te vragen is. Deze kaart toont alleen leveranciers uit EU-lidstaten; uitgaven bij niet-EU-leveranciers verschijnen hier niet. Er verschijnt een waarschuwing wanneer het terug te vorderen bedrag onder het minimum ligt dat de EU-teruggaafprocedure voor dat land vereist, zodat je weet dat je voor dat bedrag geen claim kunt indienen.
...
**Vergrendelde perioden en bulkacties.** Bulkacties op uitgaven of facturen worden geweigerd zodra één of meer geselecteerde regels in een vergrendelde BTW-periode vallen. De foutmelding noemt het exacte tijdvak (bijvoorbeeld "1 apr 2026 t/m 30 jun 2026") en legt uit wat de echte vervolgstap is. Is de periode al aangegeven, dan is de enige route een suppletieaangifte. Is het een kaal slot (de aangiftedeadline is verstreken, maar er is geen aangifte ingediend), dan kun je de periode op deze pagina tijdelijk ontgrendelen, of de regels in dat tijdvak uit je selectie halen en het opnieuw proberen.

**Vergrendelde perioden en formuliercorrecties.** Een factuur of uitgave in een vergrendelde periode bewerken wordt in het formulier geblokkeerd: de financiële velden worden alleen-lezen (notities blijven bewerkbaar) en het formulier biedt een correctiepad, zoals een correctie in de huidige open periode of een correctiefactuur. Dezelfde beveiliging geldt bij het boeken van een banktransactie of het markeren van een uitgave als betaald: als de transactie in een vergrendelde periode valt, blokkeert de app het en wijst je naar een correctie in de huidige open periode.
