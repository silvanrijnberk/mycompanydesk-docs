...
If you're the first person from your company, create a new workspace:
...
- **Freelancer** — Simplified view focused on invoicing and income
- **Project-based** — Project profitability and time tracking focus
- **AR (Invoicing)** — Invoice metrics and payment tracking
- **AP (Purchasing)** — Expense tracking and vendor management
- **VAT Compliance** — VAT calculations and deadlines
- **Growth / Operations** — Revenue trends and customer acquisition

You can change your dashboard profile at any time from the dashboard settings.
