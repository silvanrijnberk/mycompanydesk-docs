...
| **Wekelijkse samenvatting** | Een e-mail op maandagochtend met een overzicht van de geïmporteerde transacties, niet-gekoppelde items en de top-3 van automatisch gecategoriseerde leveranciers. |
...
- Aantal nieuwe geïmporteerde transacties.
