...
- De [instelwizard](/nl/features/setup-wizard) vult de meeste bedrijfsinstellingen bij de eerste start en kun je altijd opnieuw doorlopen.
- [Je persoonlijke instellingen](/nl/account/profile) behandelt de groep Over jou in detail.
- [Beveiliging](/nl/account/security) behandelt wachtwoorden, verificatie in twee stappen en passkeys.
- [Gegevens importeren en exporteren](/nl/account/data) behandelt Gegevens downloaden en CSV-import.
- [Teambeheer](/nl/settings/team) behandelt toegang voor partners en boekhouders.
- [Abonnement en plannen](/nl/settings/billing) behandelt je abonnement.
