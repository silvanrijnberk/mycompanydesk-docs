...
5. Use "Save as Draft" if it is not ready yet, or "Finalize" when the invoice is ready
6. After saving, open the invoice detail page to preview or send it

Tip: Company defaults like numbering, payment terms, and PDF settings live under Company.
