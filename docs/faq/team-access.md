...
Permissions are managed per page with Read, Write and Create options. Inviting team members requires the **Office** plan; the accountant section on the same page is free on every plan.
