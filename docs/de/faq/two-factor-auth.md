...
Die Zwei-Faktor-Authentifizierung ist in dieser App-Version derzeit nicht verfuegbar.

Du kannst trotzdem Mein Konto → Sicherheit oeffnen, um die aktuell verfuegbaren Sicherheitsoptionen dort zu sehen.

Wenn 2FA spaeter hinzugefuegt wird, erscheint sie in diesem Bereich.
