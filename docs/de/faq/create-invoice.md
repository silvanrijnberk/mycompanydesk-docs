...
5. Nutze „Als Entwurf speichern", wenn die Rechnung noch nicht fertig ist, oder „Finalisieren", wenn sie bereit ist
6. Oeffne nach dem Speichern die Rechnungsdetailseite, um sie zu pruefen oder zu senden

Tipp: Einstellungen wie Nummerierung, Zahlungsfristen und PDF-Standards findest du unter Unternehmen.
