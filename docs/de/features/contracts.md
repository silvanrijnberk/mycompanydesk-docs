...
Verträge repräsentieren laufende Vereinbarungen mit Kunden, etwa monatliche Dienstleistungsverträge, Mietvereinbarungen oder Wartungspläne. Sie können automatisch Rechnungen nach einem festgelegten Zeitplan generieren.

::: info
Das Vertragsmodul ist optional. Aktivieren Sie es unter **Einstellungen > Onderdelen**, wenn Sie es nicht in der Navigation sehen.
:::
...
2. Füllen Sie aus:
   ...
   - **Leistung und Betrag**: Was Sie liefern und der wiederkehrende Abrechnungsbetrag
...
Ein Vertrag hat kein Enddatumsfeld; er rechnet weiter ab, bis Sie ihn pausieren. Im Formular wählen Sie außerdem, wann die erste Rechnung erstellt werden soll und ob generierte Rechnungen automatisch versendet werden.
...
| **Pausiert** | Angehalten, keine Rechnungen werden generiert |

Am Ende seiner Laufzeit kann ein Vertrag außerdem als **Beendet**, **Abgelaufen** oder **Gekündigt** angezeigt werden.
...
Die Vertragsliste zeigt zusammenfassende Karten:

- **Aktive Verträge**, mit der Gesamtzahl daneben
- **Monatlicher Umsatz** aus aktiven Verträgen, normalisiert über die Abrechnungsfrequenzen hinweg
- **Verträge gesamt**
- **Nächste Rechnung**, das Datum, an dem die nächste Vertragsrechnung generiert wird

Klicken Sie auf eine Karte, um die Liste entsprechend zu filtern.

## Massenaktionen

Wählen Sie mehrere Verträge aus, um sie auf einmal zu **archivieren** oder zu **löschen**. Die Archivansicht bietet Wiederherstellen oder Verschieben in den Papierkorb; die Papierkorbansicht bietet Wiederherstellen oder endgültiges Löschen.
...
Bei Eingabe eines falschen Codes kann der Unterzeichner einen neuen anfordern. Sie schalten die SMS-Verifizierung pro Unterzeichner ein, wenn Sie die Parteien zum Vertrag hinzufügen; so können Sie sie für eine Partei verlangen und für eine andere nicht.
...
- Nutzen Sie den Statusfilter, um aktive und pausierte Verträge auf einen Blick zu sehen
