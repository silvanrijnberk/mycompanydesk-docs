  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Work orders', link: '/en/features/werkbonnen' },
        ...
        { text: 'Online appointments', link: '/en/features/site-bookings' },
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Werkbonnen', link: '/features/werkbonnen' },
        ...
        { text: 'Online afspraken', link: '/features/site-bookings' },
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Aufgaben', link: '/de/features/tasks' },
        { text: 'Arbeitsberichte', link: '/de/features/werkbonnen' },
        ...
        { text: 'Online-Termine', link: '/de/features/site-bookings' },
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Tâches', link: '/fr/features/tasks' },
        { text: "Bons d'intervention", link: '/fr/features/werkbonnen' },
        ...
        { text: 'Rendez-vous en ligne', link: '/fr/features/site-bookings' },
        ...
        { text: 'Infolettres', link: '/fr/features/newsletters' },
      ],
    },
    {
      text: 'Paramètres',
